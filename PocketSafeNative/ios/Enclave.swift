...
class Enclave: NSObject {
  ...
  func getPublicKey(
    ...
    print("[Enclave] getPublicKey called")
  ...
  func generateKeyPair(
    ...
    print("[Enclave] generateKeyPair called")
  ...
  func deleteKeyPair(
    ...
    print("[Enclave] deleteKeyPair called")
    let tag = (alias as String).data(using: .utf8)!
  ...
  func signMessage(
    ...
    print("[Enclave] signMessage called")
